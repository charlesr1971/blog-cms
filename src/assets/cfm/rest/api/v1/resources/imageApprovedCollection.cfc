...
<cfcomponent extends="taffy.core.resource" taffy_uri="/images/approved/{page}">
  ...
  <cffunction name="get">
    ...
    <CFQUERY NAME="local.qGetFile" DATASOURCE="#request.domain_dsn#">
      SELECT * 
      FROM tblFile 
      WHERE User_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#local['userid']#"> AND Approved = <cfqueryparam cfsqltype="cf_sql_tinyint" value="1">
