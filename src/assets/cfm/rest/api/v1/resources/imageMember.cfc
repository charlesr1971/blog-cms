...
<cfcomponent extends="taffy.core.resource" taffy_uri="/image/{fileUuid}">
  ...
  <cffunction name="post">
    ...
    <cfdump var="#local.jwtString#" abort />--->
