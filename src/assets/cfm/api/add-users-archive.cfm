    ...
    <cfif qGetUserArchive.RecordCount>
      <cftransaction>
        ...
        <cfloop query="qGetFileArchive">
          <CFQUERY DATASOURCE="#request.domain_dsn#">
            INSERT INTO tblFile (File_ID,User_ID,File_uuid,Category,Clientfilename,Filename,ImagePath,Author,Title,Description,Article,Size,Likes,Cfid,Cftoken,Tags,Publish_article_date,Approved,FileToken,Submission_date) 
            VALUES (<cfqueryparam cfsqltype="cf_sql_integer" value="#qGetFileArchive.File_ID#">,<cfqueryparam cfsqltype="cf_sql_integer" value="#qGetFileArchive.User_ID#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#qGetFileArchive.File_uuid#" null="#yesNoFormat(NOT len(trim(qGetFileArchive.File_uuid)))#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#qGetFileArchive.Category#" null="#yesNoFormat(NOT len(trim(qGetFileArchive.Category)))#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#qGetFileArchive.Clientfilename#" null="#yesNoFormat(NOT len(trim(qGetFileArchive.Clientfilename)))#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#qGetFileArchive.Filename#" null="#yesNoFormat(NOT len(trim(qGetFileArchive.Filename)))#">,<cfqueryparam cfsqltype="cf_sql_longvarchar" value="#qGetFileArchive.ImagePath#" null="#yesNoFormat(NOT len(trim(qGetFileArchive.ImagePath)))#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#qGetFileArchive.Author#" null="#yesNoFormat(NOT len(trim(qGetFileArchive.Author)))#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#qGetFileArchive.Title#" null="#yesNoFormat(NOT len(trim(qGetFileArchive.Title)))#">,<cfqueryparam cfsqltype="cf_sql_longvarchar" value="#qGetFileArchive.Description#" null="#yesNoFormat(NOT len(trim(qGetFileArchive.Description)))#">,<cfqueryparam cfsqltype="cf_sql_longvarchar" value="#qGetFileArchive.Article#" null="#yesNoFormat(NOT len(trim(qGetFileArchive.Article)))#">,<cfqueryparam cfsqltype="cf_sql_integer" value="#qGetFileArchive.Size#">,<cfqueryparam cfsqltype="cf_sql_integer" value="0">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#qGetFileArchive.Cfid#" null="#yesNoFormat(NOT len(trim(qGetFileArchive.Cfid)))#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#qGetFileArchive.Cftoken#" null="#yesNoFormat(NOT len(trim(qGetFileArchive.Cftoken)))#">,<cfqueryparam cfsqltype="cf_sql_longvarchar" value="#qGetFileArchive.Tags#" null="#yesNoFormat(NOT len(trim(qGetFileArchive.Tags)))#">,<cfqueryparam cfsqltype="cf_sql_timestamp" value="#qGetFileArchive.Publish_article_date#" null="#yesNoFormat(NOT len(trim(qGetFileArchive.Publish_article_date)))#">,<cfqueryparam cfsqltype="cf_sql_tinyint" value="#qGetFileArchive.Approved#">,<cfqueryparam cfsqltype="cf_sql_varchar" value="#qGetFileArchive.FileToken#" null="#yesNoFormat(NOT len(trim(qGetFileArchive.FileToken)))#">,<cfqueryparam cfsqltype="cf_sql_timestamp" value="#qGetFileArchive.Submission_date#">)
          </CFQUERY>
        </cfloop>
        <CFQUERY DATASOURCE="#request.domain_dsn#">
          DELETE 
