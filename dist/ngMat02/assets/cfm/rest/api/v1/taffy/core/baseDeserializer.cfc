<cfcomponent output="false" hint="a helper class to decode input data">
    ...
    <cffunction name="getFromHTML" output="false" taffy:mime="text/html" hint="get data from form post">
      <cfargument name="body" />
      <cfreturn { data: body } />
    </cffunction>
    
    <cffunction name="getFromJpeg" output="false" taffy:mime="image/jpeg" hint="get data from form post">
      <cfargument name="body" />
      <cfreturn { data: body } />
    </cffunction>
    
    <cffunction name="getFromJpg" output="false" taffy:mime="image/jpg" hint="get data from form post">
      <cfargument name="body" />
      <cfreturn { data: body } />
    </cffunction>
    
    <cffunction name="getFromGif" output="false" taffy:mime="image/gif" hint="get data from form post">
      <cfargument name="body" />
      <cfreturn { data: body } />
    </cffunction>
    
    <cffunction name="getFromPng" output="false" taffy:mime="image/png" hint="get data from form post">
      <cfargument name="body" />
      <cfreturn { data: body } />
    </cffunction>
